...
// var guest = ["sana", "aina", "atiqa", "javeria"];
// console.log(guest + " " + "you  found a bigger dinner table");
// guest.unshift("haya");
// guest.splice(2, 0, "hina");
// guest.push("maheen");
// guest.map((function (item) { return console.log("Dear ".concat(item, ", i found a bigger dinner table so i am invited more peoples")); }));
