...
let guestarr:string[] = ["sana" , "uzma" , "atiqa", "javeria"];

let canNotAttent:string ="uzma";
console.log(canNotAttent + " " + "can not make it, for dinner");


let Newguest:string = "aina"
guestarr[guestarr.indexOf(canNotAttent)] = Newguest
